...
model = Pipeline(steps=[
    ...
    ('classifier', XGBClassifier(n_estimators=1000, random_state=42))  # Usando XGBClassifier
]) # Os estimadores são arvores de decisão
...
# Fazer previsões e avaliar o modelo com XGBoost
